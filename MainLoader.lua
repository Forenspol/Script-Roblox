...
ESPFrame.Size = UDim2.new(0,360,0,260)
...
CloseConfigBtn.MouseButton1Click:Connect(function() ESPFrame.Visible=false end)
...
local startX,startY,spacing,squareSize=10,40,10,30
...
for i,c in ipairs(colors) do
	...
	local btn=Instance.new("TextButton",colorSquare)
...
PlayerListFrame.Size=UDim2.new(1,-20,0,150) -- taille fixe pour voir 11 joueurs
...
local function refreshPlayerList()
	...
	PlayerListFrame.CanvasSize=UDim2.new(0,0,totalHeight>150 and totalHeight or 0,0)
end
...
btnESPConfig.MouseButton1Click:Connect(function() ESPFrame.Visible=not ESPFrame.Visible end)
